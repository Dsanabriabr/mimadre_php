...
@php($landing_page_links = isset($landing_page_links->value) ? json_decode($landing_page_links->value, true) : null)
    ...
    <section class="banner-section"
        ...
        <div data-v-2bc7b97a="" class="block-background transition-with-bg" style="--75179586: 85%; --2d773441: transparent; --71ade448: 85%; --14b77476: 15%; --442a667d: 0.45;">
        <video
                src="{{dynamicStorage('storage/app/public/header_image')}}/8279989-hd_720_1280_24fps.mp4" autoplay loop
                muted playsinline class=""
                style="position: absolute;left: 0;z-index: -1;display: block;width: 100%;height: 125%;object-fit: cover;"
                poster="https://images.pexels.com/videos/8279989/adult-argentina-argentina-food-asado-8279989.jpeg?auto=compress&amp;cs=tinysrgb&amp;fit=crop&amp;h=1200&amp;w=630">
            </video>
    ...
    <!-- ======= Feature Section ======= -->
    @if (
    isset($landing_data['services_title']) && (
